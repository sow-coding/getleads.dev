...
export const stackData = [
    ...
    'Sencha Touch', 'Onsen UI', 'MongoDB', 'Firebase', 'Realm', 'GitHub',
    'GitLab', 'Jenkins', 'Kubernetes', 'Trello', 'Eclipse', 'Mocha', 'Karma',
    'Plotly', 'Highcharts', 'Chart.js', 'Leaflet', 'Bokeh', 'DataTables',
    'WebAssembly', 'Dart', 'CoffeeScript', 'Apex', 'SAS', 'Elm',
    'Scratch', 'Whitespace', 'Squirrel', 'Angular', 'ASP.NET MVC', 'Express',
    'Next.js', 'Nuxt.js', 'Phalcon', 'Mustache', 'Sinatra', 'Faveo', 'Snap',
    'Titanium', 'Quasar Framework', 'Unity', 'Phaser', 'Cocos2d', 'Grafana',
    'Datadog', 'Postman', 'JIRA', 'Asana', 'Basecamp', 'Mantis', 'Gatling',
